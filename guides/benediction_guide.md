...
1. Swap Grey Fox for Lyra and traits. It will change that healing and Greying Bite removal will be put only on one player while second will focus more on sustaining damage buffs.
2. Swap one Fiona for Zero for instances that requires tank. It will additionally provide damage and healing boost in place of resistance boost that would our tank get from Fiona's link.
