...
When Star of Oblivion is in the active team, then you can teleport straight to any boss AND it automatically switches to a channel where the boss is alive. Can be triggered once per minute. 

Open map > World Boss > Pick boss and press GO > Divine Arrival.
